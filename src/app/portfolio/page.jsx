              ...
              >
                ...
                >
                  ...
                  {/* <Link href={item.link} className="flex justify-end">
                    <button className="p-1 text-sm md:p-2 md:text-sm lg:p-4 lg:text-lg bg-white text-gray-600 font-semibold m-2 rounded">
                      See Demo
                    </button>
                  </Link> */}
                  <Link href={item.link} className="flex justify-end">
                    <button className="p-1 text-sm md:p-2 md:text-sm lg:p-4 lg:text-md bg-white text-gray-600 font-bold m-2 rounded transition duration-300 ease-in-out hover:bg-gray-200 hover:text-gray-800">
                      See Demo
                    </button>
                  </Link>
                </div>
