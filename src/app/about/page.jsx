        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:w-1/2">
          ...
          <div className="flex flex-col gap-12 justify-center">
            ...
            <p className="text-lg">
              ...
              interested in Game development and Game design Beacuse video
              gaming is part of my life😁. I also like to do creative things and
              I think I have the skill to do that. So currently I have a 3.26
              GPA. I’m always trying to update with new technologies and
              continuously learning all the things currently doing as well as
              what I would like to do in the future.👨🏻‍💻
            </p>
            {/* BIOGRAPHY QUOTE */}
            <span className="italic">◻▫What is "real"?▪◼</span>
            {/* BIOGRAPHY SIGN SVG*/}
              ...
              <div className="flex justify-between h-48">
                ...
                <div className="w-1/3 ">
                  ...
                  <div className="p-3 text-sm italic">
                    ...
                    technogies,frameworks,some essential parts and best
                    practices.{' '}
                  </div>
                  {/* JOB DATE */}
